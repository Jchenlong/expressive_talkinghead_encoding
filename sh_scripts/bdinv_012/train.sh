...
function main
{
    CUDA_VISIBLE_DEVICES=0,1,2,3 python tools/f_space_training.py \
                                 --config_path ./scripts/${exp_name}/config.yaml \
                                 --save_path /data1/chenlong/0517/video/0822/eR6CMmTu_2/eR6CMmTu_2_exp_set_v4_depoly/exp/f_space_bdinv_012/encoder \
                                 --gpus 4 \
